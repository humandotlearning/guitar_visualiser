...
const OrientationPrompt = () => {
  ...
  return (
    <div
      ...
      aria-describedby="orientation-prompt-desc"
    >
      <div className="orientation-prompt-content">
        <div className="rotate-icon" aria-hidden="true"></div>
        <h3 id="orientation-prompt-title">Rotate Your Device</h3>
        <p id="orientation-prompt-desc">For the best experience viewing the fretboard, please rotate your device to landscape mode.</p>
