      ...
      >
        {NOTES.map(note => (
          <button
            ...
            className={`
                px-2 py-2 rounded-lg text-sm font-bold transition-all duration-200 border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2
                ${rootNote === note
