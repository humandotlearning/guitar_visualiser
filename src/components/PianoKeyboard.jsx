  ...
  return (
    <div className="piano-wrapper">
      ...
      <div className="piano-controls">
        ...
        >
          {showScaleVisualization ? (
            <span className="w-4 h-4 inline-flex items-center justify-center min-w-[1rem]" aria-hidden="true">✓</span>
          ) : (
            <span className="w-4 h-4 inline-block min-w-[1rem]" aria-hidden="true"></span>
          )}
