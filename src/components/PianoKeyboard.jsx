  ...
  return (
    <div className="piano-wrapper">
      ...
      <div className="piano-controls">
        ...
        >
          <span aria-hidden="true" className="w-4 h-4 inline-flex items-center justify-center min-w-[1rem]">{showScaleVisualization ? '✓' : ''}</span>
        ...
        >
          <span aria-hidden="true" className="w-4 h-4 inline-flex items-center justify-center min-w-[1rem]">{showChordVisualization ? '✓' : ''}</span>
