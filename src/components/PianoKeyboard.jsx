  ...
  return (
    <div className="piano-wrapper">
      ...
      <div className="piano-controls">
        ...
        >
          <span className="w-4 h-4 min-w-[1rem] inline-flex justify-center items-center" aria-hidden="true">{showScaleVisualization ? '✓' : ''}</span>
        ...
        >
          <span className="w-4 h-4 min-w-[1rem] inline-flex justify-center items-center" aria-hidden="true">{showChordVisualization ? '✓' : ''}</span>
