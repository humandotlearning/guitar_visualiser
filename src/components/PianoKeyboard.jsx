  ...
  return (
    <div className="piano-wrapper">
      ...
      <div className="piano-controls">
        ...
        >
          <span aria-hidden="true" className="w-4 h-4 flex items-center justify-center min-w-[1rem]">{showScaleVisualization ? '✓' : ''}</span> <span>Show Scale Notes</span>
        </button>
        <button
        ...
        >
          <span aria-hidden="true" className="w-4 h-4 flex items-center justify-center min-w-[1rem]">{showChordVisualization ? '✓' : ''}</span> <span>Show Chord Highlighting</span>
        </button>
      </div>
