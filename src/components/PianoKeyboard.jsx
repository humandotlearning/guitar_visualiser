  ...
  return (
    <div className="piano-wrapper">
      ...
      <div className="piano-controls">
        ...
        >
          {showScaleVisualization ? <span aria-hidden="true" className="w-4 h-4 flex items-center justify-center p-0 min-w-[1rem]">✓</span> : <span aria-hidden="true" className="w-4 h-4 min-w-[1rem]"></span>} <span>Show Scale Notes</span>
        </button>
        <button
        ...
        >
          {showChordVisualization ? <span aria-hidden="true" className="w-4 h-4 flex items-center justify-center p-0 min-w-[1rem]">✓</span> : <span aria-hidden="true" className="w-4 h-4 min-w-[1rem]"></span>} <span>Show Chord Highlighting</span>
        </button>
      </div>
