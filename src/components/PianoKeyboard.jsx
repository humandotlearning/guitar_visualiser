  ...
  return (
    <div className="piano-wrapper">
      ...
      <div className="piano-controls">
        ...
        >
          {showScaleVisualization ? <span aria-hidden="true" className="w-4 h-4 min-w-[1rem] inline-block text-center">✓</span> : <span className="w-4 h-4 min-w-[1rem] inline-block"></span>} <span>Show Scale Notes</span>
        </button>
        <button
        ...
        >
          {showChordVisualization ? <span aria-hidden="true" className="w-4 h-4 min-w-[1rem] inline-block text-center">✓</span> : <span className="w-4 h-4 min-w-[1rem] inline-block"></span>} <span>Show Chord Highlighting</span>
        </button>
      </div>
