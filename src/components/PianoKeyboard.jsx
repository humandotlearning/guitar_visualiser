  ...
  return (
    <div className="piano-wrapper">
      ...
      <div className="piano-controls">
        ...
        >
          {showScaleVisualization
            ? <span aria-hidden="true" className="w-4 h-4 p-0 min-w-[1rem] flex items-center justify-center">✓</span>
            : <span aria-hidden="true" className="w-4 h-4 p-0 min-w-[1rem] inline-block"></span>
          }
