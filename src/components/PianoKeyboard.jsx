  ...
  return (
    <div className="piano-wrapper">
      ...
      <div className="piano-controls">
        ...
        >
          {showScaleVisualization ? <span aria-hidden="true">✓</span> : null} <span>Show Scale Notes</span>
        </button>
        <button
        ...
        >
          {showChordVisualization ? <span aria-hidden="true">✓</span> : null} <span>Show Chord Highlighting</span>
        </button>
      </div>
